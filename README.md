# directory-drift-checker

[![CI](https://github.com/LazyPanda902/directory-drift-checker/actions/workflows/ci.yml/badge.svg)](https://github.com/LazyPanda902/directory-drift-checker/actions/workflows/ci.yml)
...
```bash
git clone https://github.com/LazyPanda902/directory-drift-checker.git
cd directory-drift-checker
python -m venv .venv
source .venv/bin/activate
python -m pip install -e '.[dev]'
pytest -q
directory-drift-checker --help
```
